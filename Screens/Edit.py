...
def edit(active_user,user_screen):
        ...
        #User has habits, show list of habits to edit.
            ...
            ans = quest.select('Which habit would you like to edit?', [habit.title for habit in active_user.habits]).ask()
            ...
            while(True):
                ...
                if(anw_attr == 'title'):
                    ...
                    ans_difficulity = quest.prompt('What new difficulity would you want to give to this habit?',[1,2,3,4,5]).ask()
                    ...
                    ans_importance = quest.prompt('What new importance would you want to give to this habit?',[1,2,3,4,5]).ask()
                    ...
                    ans_style = quest.prompt('What new style would you want to give to this habit?',[0,1]).ask()
