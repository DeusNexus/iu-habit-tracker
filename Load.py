...
def Habit_Model(res):
    habit = {
        ...
        'interval':str(res[4]),
        'active': True if (res[5] == '1' or res[5] == 'True') else False,
        ...
        'is_dynamic': True if (res[12] == '1' or res[12] == 'True') else False,
...
def Checkin_Model(res):
    checkin = {
        ...
        'success': True if (res[5] == '1' or res[5] == 'True') else False,
        'note':str(res[6]),
        'rating':int(res[7]),
        'cost':float(res[8]),
        'cost_accum':float(res[9]),
        'dynamic': True if (res[10] == '1' or res[10] == 'True') else False,
